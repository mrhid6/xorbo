...
public class ContainerZoroGen extends ContainerXorbo
{
	public float energy = -1;
	protected TileZoroGen tileEntity;

	public ContainerZoroGen(EntityPlayer inventory, TileZoroGen te)
	{
		tileEntity = te;
		addSlotToContainer(new Slot(this.tileEntity, 0, 82, 24));
	...
	public void detectAndSendChanges()
	{
		...
		for (int i = 0; i < this.crafters.size(); i++)
		{
			...
			if(this.energy!=this.tileEntity.getEnergy())
				icrafting.sendProgressBarUpdate(this, 1, (int)this.tileEntity.getEnergy());
		}
	...
	public void updateProgressBar(int i, int j)
	{
		...
		{
		case 1:
			this.tileEntity.myProvider.setEnergyStored(j);
			break;
		}
	}
