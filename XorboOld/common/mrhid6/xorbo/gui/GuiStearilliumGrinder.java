...
public class GuiStearilliumGrinder extends GuiMain
{
	public ContainerStearilliumGrinder container;

	public GuiStearilliumGrinder(ContainerStearilliumGrinder container)
	{
		super(container);
	...
	{
		fontRenderer.drawString("Stearillium Grinder", 50, 6, 4210752);
