...
public class ContainerTriniumCore extends ContainerXorbo{
	public float energy = -1;
	protected TETriniumCore tileEntity;

	public ContainerTriniumCore(EntityPlayer inventory, TETriniumCore te)
	{
		tileEntity = te;
