...
public class RenderTEStearilliumCrafter extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z, float f) {
		...
		if (tpb.worldObj.getBlockId(tpb.xCoord, tpb.yCoord + 1, tpb.zCoord) == 0 && tpb.worldObj.getClosestPlayer(tpb.xCoord, tpb.yCoord, tpb.zCoord, 15) != null) {
			for(int i=0;i<tpb.inventory.length;i++){
	...
	public float[] setItemPosition(int id){
		...
		switch(id){
		case 0:res[0]=0.31F;res[1]=0.31F;break;
		case 1:res[0]=0.5F;res[1]=0.31F;break;
		case 2:res[0]=0.69F;res[1]=0.31F;break;
		
		case 3:res[0]=0.31F;res[1]=0.5F;break;
		case 4:res[0]=0.5F;res[1]=0.5F;break;
		case 5:res[0]=0.69F;res[1]=0.5F;break;
		
		case 6:res[0]=0.31F;res[1]=0.69F;break;
		case 7:res[0]=0.5F;res[1]=0.69F;break;
		case 8:res[0]=0.69F;res[1]=0.69F;break;
		}
