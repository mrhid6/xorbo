...
public class BlockTriniumChiller extends BlockMachine{
	...
	public void registerIcons( IconRegister iconRegister ) {
		...
		int i=0;
		for(;i<6;i++){
			icons[i] = iconRegister.registerIcon("xorbo:tc"+i);
		}
		icons[i] = iconRegister.registerIcon("xorbo:triniumbrick");++i;
		icons[i] = iconRegister.registerIcon("xorbo:tc17");
		i+=8;
