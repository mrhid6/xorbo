...
public class WinterbirchLeaves extends BlockLeaves {
	...
	public boolean shouldSideBeRendered( IBlockAccess par1iBlockAccess,
		...
		return !par1iBlockAccess.isBlockOpaqueCube(par2, par3, par4) ? true
				: par1iBlockAccess.getBlockId(par2, par3, par4) == blockID ? graphicsLevel
						: false;
	}
}
